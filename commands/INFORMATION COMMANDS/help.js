    ...
    run: async (client, message, args) => {
        ...
        function getAll(client, message) {
            ...
            *more coming soon*
            ...
            >>> <@768441096887730177> \`skiitle#0100\` [\`Website\`](nightrow.eu) [\`INVITE\`](https://bit.ly/mikami_yt) [\`Support Server\`](https://discord.gg/wvCp7q88G3)
            `)
                .addField("**__Music - Supported sources__**", `
            >>> \`Youtube\`, \`Spotify\`, \`Soundcloud\`, [\`More\`](https://bit.ly/mikami_yt), ...
            `)
                .setFooter(`Made by: skiitle#0100 | skiitle#0100`, client.user.displayAvatarURL())
