...
module.exports = (client) => {
    ...
    client.on("ready", () => {
        setInterval(() => {
            ...
            if (stateswitch) client.user.setActivity(`${config.prefix}help | nightrow.eu`, {
                type: "PLAYING"
            });
    ...
    function getAll(client, guild) {
        const embed = new MessageEmbed()
            ...
            .addField("**__BOT BY:__**", `
                >>> <@768441096887730177> \`skiitle#0100\` [\`Website\`](https://nightrow.eu) [\`INVITE\`](https://discord.com/api/oauth2/authorize?client_id=789845410998779904&permissions=8&scope=bot)
                `)
            .addField("**__Music - Supported sources__**", `
                >>> \`Youtube\`, \`Soundcloud\`, [\`More\`](https://links.nightrow.eu), ...
                `)
