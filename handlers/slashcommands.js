    ...
    client.on('ready', () => {
        ...
        client.ws.on('INTERACTION_CREATE', async interaction => {
            ...
            const inviteembed = new Discord.MessageEmbed()
                ...
                .setDescription(`[\`Click here\`](https://bit.ly/mikami_yt)   |   [\`Website\`](nightrow.eu)   |   :heart: Thanks for inviting!`)
                .setFooter(client.user.username + " | Syntax:  <>...must    []...optional", client.user.displayAvatarURL())
                .setAuthor(interaction.member.user.username, client.user.displayAvatarURL(), "https://bit.ly/mikami_yt")
            ...
            const infoembed = new Discord.MessageEmbed()
                .setAuthor(
                    ...
                    client.user.displayAvatarURL(), "https://bit.ly/mikami_yt"
                )
                .setColor(config.colors.yes)
                .addFields({
                        name: 'Bot tag',
...

                    {
                        ...
                        value: `**\`skittle#0100\` <@768441096887730177>**`,
                        inline: true,
                    },
                )
                .addField("\u200b", `
            ...
            `)
                .addField("***BOT BY:***", `
            >>> <@768441096887730177> \`skittle#0100\` [\`Website\`](nightrow.eu)
            `)
                .addField("***SUPPORT:***", `
            >>> [\`Server\`](https://discord.gg/m4T9HE6dCu) | [\`Creator Youtube\`](nightrow.eu) | [\`Invite\`](https://bit.ly/mikami_yt/)
            `)
            const helpembed = new Discord.MessageEmbed()
                ...
                *more coming soon*
                ...
                >>> <@768441096887730177> \`skiitle#0100\` [\`Website\`](nightrow.eu) [\`INVITE\`](https://bit.ly/mikami_yt)
                `)
                .addField("**__Music - Supported sources__**", `
                >>> \`Youtube\`, \`Spotify\`, \`Soundcloud\`, [\`More\`](https://links.nightrow.eu), ...
                `)
